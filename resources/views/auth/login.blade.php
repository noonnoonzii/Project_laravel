		...
		<div class="container">
			...
			<div class="row justify-content-center">
	          ...
	          <div class="social d-flex text-center">
	          	<a href="#" class="px-2 py-2 mr-md-1 rounded text-center"><span class="ion-logo-google mr-2"></span> Google</a>
	          	<a href="#" class="px-2 py-2 ml-md-1 rounded tex-center"><span class="ion-logo-facebook mr-2"></span> Facebook</a>
	          	<a href="#" class="px-2 py-2 ml-md-1 rounded text-center"><span class="ion-logo-twitter mr-2"></span> Twitter</a>
	          </div>
		      </div>	
				</div>
			</div>
