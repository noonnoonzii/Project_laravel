                ...
                <h1 class="h2 text-black text-center"><b>Shop</b></h1>
                    ...
                    <h3 class="h4 text-black"><b>New Product</b></h3>
                        <div class="card-group">
                            <div class="card">
                                <img src="./assets/img/product/fashion/shirt/shirt_1.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                    ...
                    <div class="row py-3">
                        ...
                        <div class="card-group">
                            <div class="card">
                                <img src="./assets/img/product/fashion/shirt/black_dreg.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h5 class="card-title">Dreg Black</h5>
                                    <p class="card-text">Price 650 bath</p>
                                </div>
                                <div class="card-footer">
                                    <small class="text-muted">Last updated 3 mins ago</small>
                                </div>
                            ...
                            <div class="card">
                                <img src="./assets/img/product/fashion/shirt/dreg_2.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h5 class="card-title">Dreg ผีหัวขาด</h5>
                                    <p class="card-text">Price 600 bath</p>
                                </div>
                                <div class="card-footer">
                                    <small class="text-muted">Last updated 3 mins ago</small>
                                </div>
                            ...
                            <div class="card">
                                <img src="./assets/img/product/fashion/shirt/shirt_1.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h5 class="card-title">Human Dreg</h5>
                                    <p class="card-text">Price 450 Baht</p>
                                </div>
                                <div class="card-footer">
                                    <small class="text-muted">Last updated 3 mins ago</small>
                                </div>
                    ...
                    <div class="row py-3">
                        ...
                        <div class="card-group">
                            <div class="card">
                                <img src="./assets/img/product/grip/bugg.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h5 class="card-title">Tape Bugg (Select Colors)</h5>
                                    <p class="card-text">Price 850 Baht</p>
                                </div>
                                <div class="card-footer">
                                    <small class="text-muted">Last updated 3 mins ago</small>
                                </div>
                            ...
                            <div class="card">
                                <img src="./assets/img/product/grip/griptape_1.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h5 class="card-title">Tape BB Gray</h5>
                                    <p class="card-text">Price 450 baht</p>
                                </div>
                                <div class="card-footer">
                                    <small class="text-muted">Last updated 3 mins ago</small>
                            ...
                            <div class="card">
                                <img src="./assets/img/product/grip/griptape_2.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h5 class="card-title">Tape BB White</h5>
                                    <p class="card-text">Price 450 Baht</p>
                                </div>
                                <div class="card-footer">
                                    <small class="text-muted">Last updated 3 mins ago</small>
                    ...
                    <div class="row py-3">
                        ...
                        <div class="card-group">
                            <div class="card">
                                <img src="./assets/img/product/hardware/hardware_1.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h5 class="card-title">Black Nut</h5>
                                    <p class="card-text"> Price 200 baht</p>
                                </div>
                                <div class="card-footer">
                                    <small class="text-muted">Last updated 3 mins ago</small>
                                </div>
                            ...
                            <div class="card">
                                <img src="./assets/img/product/hardware/hardware_2.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h5 class="card-title">Orange Nut</h5>
                                    <p class="card-text">Price 150 baht</p>
                                </div>
                                <div class="card-footer">
                                    <small class="text-muted">Last updated 3 mins ago</small>
                                </div>
                            ...
                            <div class="card">
                                <img src="./assets/img/product/hardware/hardware_3.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h5 class="card-title">Lucky Hardware Nut</h5>
                                    <p class="card-text">price 139 bath</p>
                                </div>
                                <div class="card-footer">
                                    <small class="text-muted">Last updated 3 mins ago</small>
                                </div>
                    ...
                    <div class="row py-3">
                        ...
                        <div class="card-group">
                            <div class="card">
                                <img src="./assets/img/product/accessories/Bag_1.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h5 class="card-title">Proper Deck Bag Black</h5>
                                    <p class="card-text">Price 850 Baht</p>
                                </div>
                                <div class="card-footer">
                                    <small class="text-muted">Last updated 3 mins ago</small>
                            ...
                            <div class="card">
                                <img src="./assets/img/product/accessories/Bag_2.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h5 class="card-title">Proper Deck Bag Yellow</h5>
                                    <p class="card-text">Price 850 Baht</p>
                                </div>
                                <div class="card-footer">
                                    <small class="text-muted">Last updated 3 mins ago</small>
                            ...
                            <div class="card">
                                <img src="./assets/img/product/accessories/Bag_3.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h5 class="card-title">proper Bag mini</h5>
                                    <p class="card-text">Price 790 Baht</p>
                                </div>
                                <div class="card-footer">
                                    <small class="text-muted">Last updated 3 mins ago</small>
                                </div>
